...
2. پردازش اولیه: این تابع بسته‌های دریافتی را برای پردازش‌های بعدی آماده می‌کند. این شامل بررسی سرآیندهای بسته و تعیین مسیریابی آن در سیستم است. 
...
5. تحویل به لایه‌های بالاتر: پس از انجام پردازش‌های اولیه و امنیتی، بسته به لایه‌های بالاتر شبکه مانند لایه حمل و نقل (مانند TCP یا UDP) یا حتی لایه کاربردی (مانند HTTP یا FTP) ارسال می‌شود. 
...
این تابع یکی از بخش‌های پیچیده و حیاتی در هسته لینوکس است و برای درک کامل آن، دانش عمیقی در مورد نحوه کارکرد شبکه‌های کامپیوتری و زیرساخت‌های مرتبط با هسته لینوکس لازم است. این تابع مستقیماً با بخش‌های دیگر سیستم عامل از جمله درایورهای دستگاه، لایه‌های شبکه و سیستم‌های امنیتی تعامل دارد.
