...
تابع `__netif_receive_skb_core` در هسته لینوکس مسئول پردازش اصلی داده‌های دریافتی است. این تابع برای پردازش بسته‌های دریافتی و ارسال آن‌ها به لایه‌های بالاتر پروتکل استفاده می‌شود. این تابع بسته‌های دریافتی را پردازش می‌کند و در صورتی که صف مربوط به پردازنده مربوطه پر باشد و به حداکثر خود رسیده باشد، بسته‌ها را رها می‌کند.

در نهایت و با آنالیز بدنه تابع مربوطه به متغیر rx\_handler رسیدیم که در این جا با استفاده از Switch case مربوطه، بسته را به OVS ارسال می کند. تصویر مربوط به این متغیر را در ذیل قرار دادیم:
